...
export const skillCategories: SkillCategory[] = [
  {
    ...
    name: "Business Analysis & Process Optimization",
    icon: Briefcase,
    skills: [
    ...
    relatedCaseStudies: ["healthcare-it", "etl-crm", "financial-recon"],
  },
  {
    id: "technical",
    name: "Technical Skills & Data Platforms",
    icon: Database,
    skills: [
      "SQL Server",
      "Snowflake",
  ...
  {
    id: "automation",
    name: "Automation & Workflow Enablement",
    icon: Workflow,
    skills: [
      "ETL-Driven Automation",
      "Rule-Based Logic",
      "Exception Handling",
      "SQL Automation",
      "Python Automation",
  ...
  {
    id: "testing",
    name: "Testing, Data Quality & Compliance",
    icon: ShieldCheck,
    skills: [
      "UAT Execution",
    ...
    relatedCaseStudies: ["healthcare-it", "financial-recon", "patient-risk"],
  },
  {
    id: "analytics",
    name: "Analytics, Dashboarding & Reporting",
    icon: BarChart3,
    skills: [
    ...
    relatedCaseStudies: ["healthcare-it", "etl-crm", "patient-risk", "etf-analysis"],
  },
];

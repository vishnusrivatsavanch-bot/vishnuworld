...
export const timelineEntries: TimelineEntry[] = [
  ...
  },
  {
    ...
    accomplishments: [
      "Improved customer retention by 12 percentage points (30% → 42%) by analyzing engagement patterns linked to long-term product usage",
      "Increased funnel conversion rates by ~35% through step-by-step acquisition funnel analysis and landing page testing",
      "Reduced reporting turnaround from multiple days to same-day analysis with SQL-based pipelines and Tableau dashboards",
      "Strengthened marketing efficiency through LTV tracking and customer segmentation for budget allocation",
      "Supported faster decision-making via weekly KPI alignment across Sales, Marketing, and Finance",
    ],
    skills: ["SQL", "Tableau", "A/B Testing", "Customer Analytics", "Cohort Analysis", "KPI Reporting"],
  },
  {
    id: "genething",
    ...
    accomplishments: [
      "Raised signup conversion by ~18% by analyzing onboarding journey data and identifying abandonment points",
      "Improved retention visibility through Tableau dashboards tracking early engagement behaviors linked to 3x stronger retention",
      "Enhanced sales pipeline accuracy by maintaining 50,000+ CRM records with improved data quality practices",
      "Enabled more targeted outreach through consistent KPI reporting in weekly strategic reviews",
      "Aligned cross-functional reporting through shared metric definitions and consistent dashboards",
    ],

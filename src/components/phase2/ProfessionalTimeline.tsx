...
const ProfessionalTimeline = () => {
  ...
  return (
    <section className="py-20 px-6 md:px-16" id="timeline">
      <motion.div
      ...
      >
        ...
        <div className="relative">
          ...
          <div className="absolute left-6 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-glow-gold/40 to-transparent md:-translate-x-px" />
          ...
          {timelineEntries.map((entry, index) => {
            ...
            return (
              ...
              >
                {/* Timeline node */}
                <motion.div
                  className="absolute left-6 md:left-1/2 -translate-x-1/2 z-10 w-4 h-4 rounded-full border-2 cursor-pointer"
                  style={{
                ...
                >
                  <motion.div
                    className="rounded-xl border border-border/20 p-6 cursor-pointer group"
                    style={{
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1.5 text-sm font-body text-muted-foreground mb-4">
                      ...
                      {isExpanded && (
                        ...
                        >
                          <div className="pt-4 border-t border-border/20">
                            <p className="text-xs font-display font-bold uppercase tracking-wider text-muted-foreground mb-3">
                              Key Accomplishments
                            </p>
                            <ul className="space-y-2.5 mb-5">
                              {entry.accomplishments.map((a, i) => (
                                <motion.li
                                  key={i}
                                  className="font-body text-sm text-foreground/80 pl-3 border-l-2"
                                  style={{

...
const sections = [
  {
    ...
    content: "Fitness isn't a hobby — it's a discipline. A structured approach to training built on progressive overload, functional movement, and consistency. The same mindset that drives results in the boardroom fuels every rep in the gym.",
    details: [
      "🏋️ Training Philosophy — Progressive overload & compound lifts",
      "🔥 Daily Non-Negotiable — Movement every single day, no excuses",
      "🥗 Nutrition — Clean fuel, macro-conscious, performance-driven eating",
      "💪 Resilience — Overcame two fractures, adapted & came back stronger",
      "🎯 Current Focus — Building strength, mobility, and mental toughness",
    ],
  },
  {
    id: "travel",
